    ...
    <div className="min-h-screen flex items-center justify-center bg-[#121212] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black text-white">Sign up free</h1>
        </div>
        <div className="rounded-2xl p-8 border border-[#282828]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#121212] border border-[#535353] text-white px-4 py-3 rounded-md text-sm focus:outline-none focus:border-white transition-colors"
              />
              <p className="text-xs text-[#b3b3b3] mt-1">At least 6 characters.</p>
            </div>
            <button
              type="submit"
              disabled={loading}
          ...
          <div className="border-t border-[#282828] mt-6 pt-6 text-center">
            <p className="text-[#b3b3b3] text-sm">
              ...
              <Link to="/login" className="text-white font-bold underline underline-offset-2 hover:text-[#1DB954]">
                Log in
              </Link>
            </p>
          </div>
